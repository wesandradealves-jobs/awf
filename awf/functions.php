<?php 
	...
	function regScripts() {
        ...
        wp_enqueue_script('commons', get_template_directory_uri()."/b5933d6b14ffc14d17be63b827bd70c1.js",'',rand(10,100), true);
    ...
    function customizer( $wp_customize ) {
            ...
            $wp_customize->add_section( 'a-empresa' , array(
            'title'       => __( 'A Empresa' ),
            'panel' => 'customization',
            'priority'    => 3
            ));    
            $wp_customize->add_setting( 'titulo' );
            ...
            $wp_customize->add_setting( 'imagem' );
            $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'imagem', array(
            'label'    => __( 'Imagem' ),
            'section'  => 'a-empresa',
            'settings' => 'imagem'
            )));  
            ...
            $wp_customize->add_setting( 'banner-titulo' );
            $wp_customize->add_control('banner-titulo',  array(
                'label' => 'Título',
                'section' => 'banner',
                'type' => 'text',
                'settings' => 'banner-titulo'
            )); 
            $wp_customize->add_setting( 'banner-texto' );
            $wp_customize->add_control('banner-texto',  array(
                'label' => 'Texto',
                'section' => 'banner',
                'type' => 'textarea',
                'settings' => 'banner-texto'
            )); 
            $wp_customize->add_setting( 'banner-imagens' );
            $wp_customize->add_control('banner-imagens',  array(
                'label' => 'Imagens (Separar por ",")',
                'section' => 'banner',
                'type' => 'textarea',
                'settings' => 'banner-imagens'
            )); 
            $wp_customize->add_setting( 'banner-label' );
            $wp_customize->add_control('banner-label',  array(
                'label' => 'Label Botão',
                'section' => 'banner',
                'type' => 'text',
            ...
            $wp_customize->add_control('banner-url',  array(
                'label' => 'URL',
                'section' => 'banner',
                'type' => 'text',
                'settings' => 'banner-url'
